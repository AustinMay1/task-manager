...
import {GoKebabVertical, GoTrashcan, GoCheck} from "react-icons/go"
                                    ...
                                    <Box>
                                        {(() => {
                                            if (project.status === "Not Started") {
                                                return (<Tag
                                                    colorScheme={'red'}><TagLabel>{project.status}</TagLabel></Tag>)
                                            } else if (project.status === "In Progress") {
                                                return (<Tag
                                                    colorScheme={'orange'}><TagLabel>{project.status}</TagLabel></Tag>)
                                            } else {
                                                return (<Tag colorScheme={'green'}><TagLabel>{project.status}</TagLabel></Tag>)
                                            }
                                        })()}
                                    </Box>
                                </Flex>
                            ...
                            <CardFooter justifyContent={"space-between"} alignItems={"center"}>
                                ...
                                <Menu>
                                    <MenuButton as={IconButton} icon={<GoKebabVertical/>}
                                                variant={"ghost"}>Edit</MenuButton>
                                    <MenuList>
                                        <MenuItem icon={<GoCheck/>}
                                                  onClick={() => completeProject(project)}>Complete</MenuItem>
                                        <MenuItem icon={<GoTrashcan/>}
                                                  onClick={() => deleteProject(project)}>Delete</MenuItem>
                                    </MenuList>
                                </Menu>
                            </CardFooter>
                        </Card>
